...
import connectpic from "./image/connectpic.jpg";
  ...
  return (
    <>
      <section className="flex flex-col justify-center items-center lg:flex-row lg:justify-around py-10 px-20">
        <div>
          <h2 className="text-2xl lg:text-3xl font-bold pb-10 lg:pb-0">
            Contact
          </h2>
        </div>
        <div>
      ...
      <section className="h-80 py-10 px-20 flex flex-col justify-center items-center lg:flex-row lg:justify-around  text-white  bg-[url('./image/connectpic.jpg')] bg-[#000]/75  bg-no-repeat bg-blend-soft-light bg-cover bg-center">
